...
public class Test1 {
    ...
    public  void testActivity(){
        ...
        onView(withId(R.id.email)).perform(typeText("hudene")).toString();
        ...
        onView(withId(R.id.email)).perform(typeText("")).toString();

        onView(withId(R.id.password)).perform(typeText("milandou"));
